...
<ul>
<li>C++17 and modern C++</li>
<li>Qt 6.x</li>
<li>CMake and qmake</li>
...
- CMake
- JSON-based configuration and data handling
...
<tr>
<td>C++ Build Systems</td>
<td>CMake, qmake, NMAKE, Ninja</td>
</tr>
<tr>
<td>Compilers</td>
<td>MSVC, MinGW</td>
...
<tr>
<td>Low-Level</td>
<td>Assembly experiments, MASM32 SDK</td>
</tr>
<tr>
<td>Packaging</td>
...
<tr>
<td>Python</td>
<td>Automation, CLI tools, prototypes, uv</td>
</tr>
<tr>
...
- Split features into clear modules
- Improve the UI and user experience
- Refactor when the structure becomes messy
- Keep the project practical and usable
...
## حوزه‌هایی که با آن‌ها کار می‌کنم
...
<li>Qt 6.x</li>
<li>CMake و qmake</li>
<li>معماری رابط کاربری ماژولار</li>
...
- CMake
- مدیریت تنظیمات و داده‌ها با JSON
...
<tr>
<td><b>دسته‌بندی</b></td>
<td><b>ابزارها و تکنولوژی‌ها</b></td>
</tr>
<tr>
<td>بیلد C++</td>
<td>CMake, qmake, NMAKE, Ninja</td>
...
- شروع با یک ایده ساده
- ساخت نمونه اولیه قابل اجرا
- جدا کردن قابلیت‌ها به ماژول‌های مشخص
- بهتر کردن رابط کاربری و تجربه کاربر
- بازنویسی بخش‌های شلوغ در زمان مناسب
- کاربردی نگه داشتن پروژه
...
- از ساخت ابزارهایی که واقعاً مشکلی را حل می‌کنند لذت می‌برم.
- به رابط کاربری تمیز و ساختار قابل نگهداری اهمیت می‌دهم.
- به آزمایش در هر دو حوزه سطح بالا و سطح پایین علاقه دارم.
- بیشتر در محیط توسعه مبتنی بر ویندوز کار می‌کنم.
- به نظرم بهتر شدن تدریجی، ارزشمندتر از کامل نشان دادن همه چیز است.
